...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      {/* Header */}
      <div className="bg-white content-stretch flex h-[68px] items-center justify-between pl-[24px] pr-[32px] relative w-full">
        ...
        {/* Navigation */}
        <div className="bg-white content-stretch flex gap-[12px] h-full items-start px-[14px] relative">
          {navItems.map((item) => {
            ...
            return (
              <Link
                key={item.path}
                to={item.path}
                className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0"
              >
                {isActive && (
        ...
        <div className="content-stretch flex gap-[8px] items-center justify-end relative shrink-0">
            ...
            <div className="bg-white relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full">
              <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex gap-[10px] items-center px-[10px] py-[7px] relative w-full">
                  <SearchIcon />
                  <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px not-italic relative text-[#a3a3a3] text-[14px] whitespace-pre-wrap">
                    Search
                  </p>
                </div>
              </div>
          ...
          <div className="bg-[#171717] overflow-clip relative rounded-[100px] shrink-0 size-[36px]">
