import svgPaths from "./svg-l86qjfzrj5";
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="document-text">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="document-text">
          <path clipRule="evenodd" d={svgPaths.pdb30e00} fill="var(--fill-0, #05376D)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Fields6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[96px]" data-name="fields">
      <Input7 />
    </div>
  );
}
...
function Button6() {
  return (
    <div className="bg-[#dbeafe] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[8px] shadow-[0px_0.5px_2px_0px_rgba(0,0,0,0.05)] shrink-0" data-name="Button">
...
function Col2() {
  return (
    <div className="relative shrink-0 w-[70px]" data-name="Col">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <CellLabel2 />
        <Cell20 />
        <Cell21 />
...
function Col3() {
  return (
    <div className="relative shrink-0 w-[148px]" data-name="Col">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <CellLabel3 />
        <Cell30 />
        <Cell31 />
...
function Cell40() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">6 m3</p>
        </div>
      </div>
    </div>
  );
...
function Cell41() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">10 m3</p>
        </div>
      </div>
    </div>
  );
...
function Cell50() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Raiņa bulvāris 5/6, Centra rajons, Rīga, LV-1050</p>
        </div>
      </div>
    </div>
  );
...
function Col5() {
  return (
    <div className="relative shrink-0 w-[120px]" data-name="Col">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <CellLabel5 />
        <Cell50 />
        <Cell51 />
  ...
  return (
    <div className="bg-[#eff6ff] relative rounded-[6px] shrink-0" data-name="Input tag">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#2563eb] text-[14px] text-center">Assigned</p>
      </div>
    </div>
  );
}
...
function InputTag1() {
  return (
    <div className="bg-[#f2fdf5] relative rounded-[6px] shrink-0" data-name="Input tag">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#16a34a] text-[14px] text-center">Accepted</p>
      </div>
    </div>
  );
}
...
function InputTag2() {
  return (
    <div className="bg-[#fffbeb] relative rounded-[6px] shrink-0" data-name="Input tag">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#c47e09] text-[14px] text-center">Awaiting paiment</p>
      </div>
    </div>
  );
}
...
function Cell80() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Postpaid invoice (PROMO)</p>
        </div>
      </div>
    </div>
  );
...
function Cell90() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Web</p>
        </div>
      </div>
    </div>
  );
...
function Cell91() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Mobile</p>
        </div>
      </div>
    </div>
  );
...
function Col9() {
  return (
    <div className="relative shrink-0 w-[72px]" data-name="Col">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <CellLabel9 />
        <Cell90 />
        <Cell91 />
...
function InputTag10() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">Received</p>
      </div>
    </div>
  );
}
...
function InputTag11() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">Scheduled</p>
      </div>
    </div>
  );
}
...
function InputTag12() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">En route</p>
      </div>
    </div>
  );
}
...
function InputTag13() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">Completed</p>
      </div>
    </div>
  );
}
...
function InputTag14() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">Finished</p>
      </div>
    </div>
  );
}
...
function InputTag15() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">Cancelled</p>
      </div>
    </div>
  );
}
...
function CellLabel13() {
  return (
    <div className="bg-[#fafafa] h-[48px] relative shrink-0 w-full" data-name="Cell label">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center px-[16px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">Ordered at</p>
          <ChevronDown24 />
        </div>
      </div>
    </div>
...
function Col13() {
  return (
    <div className="relative shrink-0 w-[116px]" data-name="Col">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <CellLabel13 />
        <Cell130 />
        <Cell131 />
...
function Cell140() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">client’s</p>
        </div>
      </div>
    </div>
  );
...
function Cell141() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">in order</p>
        </div>
      </div>
    </div>
  );
...
function Col14() {
  return (
    <div className="relative shrink-0 w-[96px]" data-name="Col">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <CellLabel14 />
        <Cell140 />
        <Cell141 />
...
function CellLabel15() {
  return (
    <div className="bg-[#fafafa] h-[48px] relative shrink-0 w-full" data-name="Cell label">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center px-[16px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">Free rental</p>
          <ChevronDown26 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="x-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="x-circle">
          <path clipRule="evenodd" d={svgPaths.p18552ac0} fill="var(--fill-0, #A3A3A3)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function CellLabel16() {
  return (
    <div className="bg-[#fafafa] h-[48px] relative shrink-0 w-full" data-name="Cell label">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center px-[16px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">Promo code</p>
          <ChevronDown27 />
        </div>
      </div>
    </div>
...
export default function Orders() {
  return (
    <div className="bg-[#fafafa] content-stretch flex flex-col items-start overflow-clip relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] size-full" data-name="Orders">
      <BarBweg />
      <Body />
    </div>
  );
