...
pdb30e00: "M2.8125 2.53125C2.8125 1.75484 3.44234 1.125 4.21875 1.125H7.875C9.8144 1.125 11.6744 1.89542 13.0457 3.26678C14.4171 4.63814 15.1875 6.4981 15.1875 8.4375V15.4688C15.1875 16.2452 14.5577 16.875 13.7812 16.875H4.21875C3.44234 16.875 2.8125 16.2452 2.8125 15.4688V2.53125ZM14.0625 8.71875C14.0625 8.1966 13.8551 7.69585 13.4859 7.32663C13.1167 6.95742 12.6159 6.75 12.0938 6.75H10.9688C10.5958 6.75 10.2381 6.60184 9.97438 6.33812C9.71066 6.0744 9.5625 5.71671 9.5625 5.34375V4.21875C9.5625 3.69661 9.35508 3.19585 8.98587 2.82663C8.61665 2.45742 8.11589 2.25 7.59375 2.25H4.21875C4.06366 2.25 3.9375 2.37616 3.9375 2.53125V15.4688C3.9375 15.6238 4.06366 15.75 4.21875 15.75H13.7812C13.9363 15.75 14.0625 15.6238 14.0625 15.4688V8.71875ZM10.3181 2.75275C10.5584 3.19935 10.6875 3.7024 10.6875 4.21875V5.34375C10.6875 5.41834 10.7171 5.48988 10.7699 5.54262C10.8226 5.59537 10.8942 5.625 10.9688 5.625H12.0938C12.6101 5.625 13.1132 5.75409 13.5597 5.99438C13.2527 5.27989 12.8108 4.62284 12.2502 4.06228C11.6897 3.50171 11.0326 3.05982 10.3181 2.75275ZM11.25 8.4375C11.5607 8.4375 11.8125 8.68934 11.8125 9V12.9375C11.8125 13.2482 11.5607 13.5 11.25 13.5C10.9393 13.5 10.6875 13.2482 10.6875 12.9375V9C10.6875 8.68934 10.9393 8.4375 11.25 8.4375ZM9 10.125C9.31066 10.125 9.5625 10.3768 9.5625 10.6875V12.9375C9.5625 13.2482 9.31066 13.5 9 13.5C8.68934 13.5 8.4375 13.2482 8.4375 12.9375V10.6875C8.4375 10.3768 8.68934 10.125 9 10.125ZM6.75 11.8125C7.06066 11.8125 7.3125 12.0643 7.3125 12.375V12.9375C7.3125 13.2482 7.06066 13.5 6.75 13.5C6.43934 13.5 6.1875 13.2482 6.1875 12.9375V12.375C6.1875 12.0643 6.43934 11.8125 6.75 11.8125Z",
} as const;
...
export default function OrdersPage() {
  ...
  return (
    <div className="bg-[#fafafa] content-stretch flex flex-col items-start overflow-clip relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] size-full">
      <div className="content-stretch flex flex-col gap-[32px] items-center pb-[48px] px-4 sm:px-8 md:px-16 lg:px-[110px] relative shrink-0 w-full">
        {/* Page Heading */}
