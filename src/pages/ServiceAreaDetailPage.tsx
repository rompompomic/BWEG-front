        ...
        <div className="content-stretch flex flex-col gap-[24px] sm:gap-[32px] items-start max-w-[1220px] w-full">
          ...
          <div className="content-stretch flex flex-col gap-[12px] sm:gap-[14px] items-start pt-4 sm:pt-6 md:pt-[32px] w-full">
            ...
            <div className="content-stretch flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between w-full">
              ...
              <button 
                onClick={() => navigate(`/companies/${providerId}/service-area/${areaId}/edit`)}
          ...
          <div className="bg-white w-full rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] overflow-hidden">
            <div className="content-stretch flex flex-col gap-[22px] items-start p-4 sm:p-5 md:p-[24px] w-full">
              {/* Map */}
              <div className="h-[250px] sm:h-[300px] md:h-[348px] relative w-full rounded-[12px] overflow-hidden">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1754299394817-ff347e940645?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYXAlMjBsb2NhdGlvbiUyMHBpbnxlbnwxfHx8fDE3NzA3MjcxNTh8MA&ixlib=rb-4.1.0&q=80&w=1080"
              ...
              {/* Info Grid */}
              <div className="content-stretch flex flex-col sm:flex-row gap-[16px] sm:gap-[22px] items-start w-full">
                {/* Name */}
                <div className="content-stretch flex flex-1 flex-col items-start min-w-0 w-full">
          ...
          <div className="content-stretch flex flex-col gap-[24px] sm:gap-[32px] items-start w-full">
            <p className="font-['Inter:Bold',sans-serif] font-bold leading-[28px] text-[#171717] text-[20px] sm:text-[24px]">
              Category prices
            </p>

            {/* Skip hire Category */}
            <div className="bg-white content-stretch flex flex-col items-start overflow-hidden rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] w-full">
              {/* Category Header */}
              <button
                onClick={() => toggleCategory('skip-hire')}
                className="content-stretch flex gap-[20px] items-center px-4 md:px-[24px] py-[16px] relative w-full border-b border-[#e5e5e5] hover:bg-[#fafafa] transition-colors"
              >
                <p className="flex-1 font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] text-[#171717] text-[16px] sm:text-[18px] text-left">
                  Skip hire
                </p>
                <svg 
                  className={`size-[24px] transition-transform ${expandedCategories['skip-hire'] ? '' : 'rotate-180'}`}
                  fill="none" 
                  viewBox="0 0 24 24"
                >
              ...
              {/* Category Body */}
              {expandedCategories['skip-hire'] && (
                <div className="content-stretch flex flex-col gap-[24px] items-start p-4 sm:p-5 md:p-[24px] w-full">
                  {/* 6 m³ */}
                  <div className="bg-[#fafafa] content-stretch flex flex-col gap-[14px] items-start p-4 sm:p-5 md:p-[24px] relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_0px_#ececee] w-full">
                    ...
                    <div className="content-stretch grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-[24px] items-end w-full">
                      {/* Base price */}
                      <div className="content-stretch flex flex-col items-start w-full">
                        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] text-[#171717] text-[14px] mb-2">
                          Base price
                        </p>
                        <div className="bg-white content-stretch flex flex-col items-start justify-center p-[8px] relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_0px_#ececee] w-full">
                          <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#171717] text-[14px] w-full">
                            100 €
                          </p>
                        </div>
                      ...
                      {/* Toggles */}
                      <div className="content-stretch flex flex-col gap-[4px] items-start justify-center w-full">
                        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] text-[#171717] text-[14px]">
                          Fix delivery price
                        </p>
                        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] text-[#171717] text-[14px]">
            ...
            {/* Containers for wood waste Category */}
            <div className="bg-white content-stretch flex flex-col items-start overflow-hidden rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] w-full">
              {/* Category Header */}
              <button
                onClick={() => toggleCategory('containers')}
                className="content-stretch flex gap-[20px] items-center px-4 md:px-[24px] py-[16px] relative w-full border-b border-[#e5e5e5] hover:bg-[#fafafa] transition-colors"
              >
                <p className="flex-1 font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] text-[#171717] text-[16px] sm:text-[18px] text-left">
                ...
                <svg 
                  className={`size-[24px] transition-transform ${expandedCategories['containers'] ? '' : 'rotate-180'}`}
                  fill="none" 
                  viewBox="0 0 24 24"
                >
                  <path clipRule="evenodd" d="M6.22 15.28C6.36063 15.4205 6.55125 15.4993 6.75 15.4993C6.94875 15.4993 7.13937 15.4205 7.28 15.28L12 10.56L16.72 15.28C16.7887 15.3537 16.8715 15.4128 16.9635 15.4538C17.0555 15.4948 17.1548 15.5168 17.2555 15.5186C17.3562 15.5204 17.4562 15.5018 17.5496 15.4641C17.643 15.4264 17.7278 15.3703 17.799 15.299C17.8703 15.2278 17.9264 15.143 17.9641 15.0496C18.0018 14.9562 18.0204 14.8562 18.0186 14.7555C18.0168 14.6548 17.9948 14.5555 17.9538 14.4635C17.9128 14.3715 17.8537 14.2887 17.78 14.22L12.53 8.97C12.3894 8.82955 12.1988 8.75066 12 8.75066C11.8012 8.75066 11.6106 8.82955 11.47 8.97L6.22 14.22C6.07955 14.3606 6.00066 14.5512 6.00066 14.75C6.00066 14.9488 6.07955 15.1394 6.22 15.28Z" fill="#A3A3A3" fillRule="evenodd" />
