  ...
  return (
    <div className="bg-[#fafafa] min-h-screen w-full">
      <div className="content-stretch flex flex-col items-start px-4 sm:px-6 md:px-8 lg:px-16 xl:px-[110px] w-full">
        ...
        <div className="content-stretch flex flex-col gap-[14px] items-start pt-[32px] relative shrink-0 w-full">
          ...
          <div className="content-stretch flex items-start relative shrink-0 w-full">
            ...
            <div className="content-stretch flex gap-[14px] items-center justify-center pr-[14px] relative rounded-[8px] shrink-0">
              ...
              <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#737373] text-[14px]">
                {isEditMode ? 'Edit service' : 'New service category'}
              </p>
            </div>
          </div>
          ...
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
            <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#171717] text-[30px] whitespace-nowrap">
              <p className="leading-[32px]">{isEditMode ? 'Edit service' : 'New service'}</p>
            </div>
            <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0">
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
                <button
                  onClick={() => setFormData({ ...formData, publicView: !formData.publicView })}
                  className={`h-[24px] overflow-clip relative rounded-[100px] shrink-0 w-[45px] ${
                    formData.publicView ? 'bg-[#05376d]' : 'bg-[#d4d4d4]'
                  }`}
                >
                  <div
                    className={`absolute bg-white rounded-[100px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] size-[20px] top-[2px] transition-all ${
                      formData.publicView ? 'left-[23px]' : 'left-[2px]'
                    }`}
                  />
                </button>
                <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">
                  Public view
                </p>
              </div>
            </div>
        ...
        {/* Form Content */}
        <div className="bg-white rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] mt-[24px] p-[24px] w-full max-w-[1220px]">
          <div className="flex flex-col gap-[24px]">
            {/* Full Name and Unique Code Row */}
            <div className="content-stretch flex gap-[24px] items-end relative shrink-0 w-full flex-col md:flex-row">
              {/* Full Name */}
              <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative w-full">
                <div className="content-stretch flex gap-[2px] items-start relative shrink-0 w-full">
                  <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#171717] text-[14px]">
                    Full name
                  </p>
                </div>
                <div className="bg-white h-[38px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full">
                  <input
                    ...
                    className="flex flex-row items-center overflow-clip rounded-[inherit] size-full px-[14px] py-[7px] font-['Inter:Regular',sans-serif] font-normal leading-[24px] text-[#171717] text-[14px] border-none outline-none"
                    placeholder="Containers for wood waste"
                  />
                </div>
              </div>
              ...
              <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative w-full">
                ...
                <div className="bg-[#fafafa] h-[38px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full">
                  <input
                    type="text"
                    value={formData.uniqueCode}
                    disabled
                    className="flex flex-row items-center overflow-clip rounded-[inherit] size-full px-[14px] py-[7px] font-['Inter:Regular',sans-serif] font-normal leading-[24px] text-[#737373] text-[14px] border-none outline-none bg-transparent"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full flex-col lg:flex-row">
              {/* Description */}
                  ...
                  <div className="bg-white content-stretch flex flex-col h-[240px] items-start overflow-clip relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full">
                    ...
                    <div className="h-[50px] relative shrink-0 w-full">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[20px] items-center px-[16px] relative size-full overflow-x-auto">
                          {/* Bold */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[12.5%_20.83%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 13.5">
                                <path clipRule="evenodd" d={svgPaths.p331f9200} fill="#404040" fillRule="evenodd" />
                              </svg>
                            </div>
                          </button>
                          {/* Italic */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[12.5%_23.96%_12.5%_22.92%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.5625 13.5005">
                                <path clipRule="evenodd" d={svgPaths.p268a3f00} fill="#404040" fillRule="evenodd" />
                              </svg>
                            </div>
                          </button>
                          {/* Strikethrough */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[12.5%_13.54%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.1253 13.5003">
                                <g>
                                  <path clipRule="evenodd" d={svgPaths.p2ec9c400} fill="#404040" fillRule="evenodd" />
                                  <path d={svgPaths.p170a7400} fill="#404040" />
                                  <path clipRule="evenodd" d={svgPaths.p16480400} fill="#404040" fillRule="evenodd" />
                                </g>
                              </svg>
                            </div>
                          </button>
                          {/* Link */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[10.25%_10.25%_9.75%_9.75%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.4 14.4">
                                <path clipRule="evenodd" d={svgPaths.p5e7b300} fill="#404040" fillRule="evenodd" />
                              </svg>
                            </div>
                          </button>
                          {/* Code */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[15%_5%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.1996 12.6005">
                                <path clipRule="evenodd" d={svgPaths.p13a2d900} fill="#404040" fillRule="evenodd" />
                              </svg>
                            </div>
                          </button>
                          {/* Bullet list */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[18.75%_12.5%_18.75%_10.42%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.875 11.25">
                                <path d={svgPaths.p2a696580} fill="#404040" />
                              </svg>
                            </div>
                          </button>
                          {/* Numbered list */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[16.67%_12.5%_16.67%_8.33%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.25 12">
                                <path d={svgPaths.p22b4a1c0} fill="#404040" />
                              </svg>
                            </div>
                          </button>
                          {/* Table */}
                          <button className="relative shrink-0 size-[18px] hover:opacity-70">
                            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
                              <g>
                                <path clipRule="evenodd" d={svgPaths.p24adb580} fill="#404040" fillRule="evenodd" />
                              </g>
                            </svg>
                          </button>
                          {/* Image */}
                          <button className="overflow-clip relative shrink-0 size-[18px] hover:opacity-70">
                            <div className="absolute inset-[15%_10%]">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.4 12.6">
                                <path clipRule="evenodd" d={svgPaths.p2bd4e980} fill="#404040" fillRule="evenodd" />
                              </svg>
                            </div>
                          </button>
                        </div>
                    ...
                    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full">
                      <div className="content-stretch flex items-start px-[16px] py-[14px] relative size-full">
                        <textarea
                          ...
                          className="flex-[1_0_0] font-['DM_Mono:Regular',sans-serif] h-full leading-[20px] min-h-px min-w-px not-italic relative text-[#262626] text-[16px] whitespace-pre-wrap border-none outline-none resize-none bg-transparent"
              ...
              {/* Photo for Web and App */}
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full lg:w-[574px]">
                <div className="content-stretch flex gap-[2px] items-start relative shrink-0 w-full">
                  <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#171717] text-[14px]">
                    Photo for Web and App
                  </p>
                </div>
                <div className="bg-white content-stretch flex items-center overflow-clip py-[29px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full cursor-pointer hover:bg-[#fafafa]">
                ...
                <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#737373] text-[14px] w-full whitespace-pre-wrap">
                  <span className="leading-[20px]">{`PNG, JPG, JPEG. `}</span>
                  <span className="leading-[20px]">{`Max file size 10mb. Optimal image dimensions: 180x180px. `}</span>
                </p>
              </div>
            </div>

            {/* Payed Service Toggle */}
            <div className="content-stretch flex items-start relative shrink-0">
              <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative shrink-0">
                <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
                  <button
                    onClick={() => setFormData({ ...formData, payedService: !formData.payedService })}
                    className={`h-[24px] overflow-clip relative rounded-[100px] shrink-0 w-[45px] ${
                      formData.payedService ? 'bg-[#05376d]' : 'bg-[#d4d4d4]'
                    }`}
                  >
                    <div
                      className={`absolute bg-white rounded-[100px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] size-[20px] top-[2px] transition-all ${
                        formData.payedService ? 'left-[23px]' : 'left-[2px]'
                      }`}
                    />
                  </button>
                  <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">
            ...
            {formData.payedService && (
              <div className="flex flex-col gap-[8px]">
                ...
                <div className="content-start flex flex-wrap gap-[6px_8px] items-start relative shrink-0 w-full">
                  {paymentMethods.map((method) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="overflow-clip relative shrink-0 size-[13px] hover:opacity-70"
                      >
                        <div className="absolute inset-[21.88%]">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.3125 7.3125">
                  ...
                  <button className="bg-white content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative rounded-[6px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 hover:bg-[#fafafa]">
                    <div className="overflow-clip relative shrink-0 size-[20px]">
            ...
            <div className="flex flex-col gap-[24px] pt-[24px] border-t border-[#e5e5e5]">
              <h3 className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic text-[#171717] text-[18px]">
                Configurations
              </h3>
              ...
              {/* Promo Categories */}
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full md:w-1/2 md:pr-3">
                <div className="content-stretch flex gap-[2px] items-start relative shrink-0 w-full">
                  <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#171717] text-[14px]">
                    Promo categories
                  </p>
                  ...
                  <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                    <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[7px] relative size-full">
                      <select
                        ...
                        onChange={(e) => setFormData({ ...formData, promoCategory: e.target.value })}
                        className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px not-italic overflow-hidden relative text-[#171717] text-[14px] text-ellipsis whitespace-nowrap bg-transparent border-none outline-none appearance-none w-full cursor-pointer"
                      >
                        <option value="">Select category</option>
              ...
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
                <button
                  onClick={() => setFormData({ ...formData, clientImageUploading: !formData.clientImageUploading })}
                  className={`h-[24px] overflow-clip relative rounded-[100px] shrink-0 w-[45px] ${
                    formData.clientImageUploading ? 'bg-[#05376d]' : 'bg-[#d4d4d4]'
                  }`}
                >
                  <div
                    className={`absolute bg-white rounded-[100px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] size-[20px] top-[2px] transition-all ${
                      formData.clientImageUploading ? 'left-[23px]' : 'left-[2px]'
                    }`}
                  />
                </button>
                <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">
            ...
            {/* Action Buttons */}
            <div className="flex gap-[12px] items-center pt-[24px] border-t border-[#e5e5e5]">
              <button
                onClick={handleSubmit}
                className="bg-[#05376d] content-stretch flex gap-[6px] items-center justify-center px-[24px] py-[10px] relative rounded-[8px] shadow-[0px_0.5px_2px_0px_rgba(0,0,0,0.05)] shrink-0 hover:bg-[#043159]"
              >
                <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[14px] text-center text-white">
                  {isEditMode ? 'Update Service' : 'Create Service category'}
                </p>
              </button>
              <button
                onClick={() => navigate('/services')}
                className="bg-white content-stretch flex gap-[6px] items-center justify-center px-[24px] py-[10px] relative rounded-[8px] shadow-[0px_0.5px_2px_0px_rgba(0,0,0,0.05),0px_0px_0px_1px_#e5e5e5] shrink-0 hover:bg-[#fafafa]"
              >
                <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#171717] text-[14px] text-center">
                  Cancel
                </p>
              </button>
            </div>
