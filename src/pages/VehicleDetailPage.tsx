...
export default function VehicleDetailPage() {
  ...
  // Mock vehicle data - в реальном приложении это будет загружаться по vehicleId
  const vehicleData = {
    regNumber: 'NM3Y4R',
    loadCapacity: '8t',
    pricePerMin: '10 €',
    ...
    technicalPassportNumber: 'NM3Y4R',
    vehicleType: 'Skip'
  };
  ...
  return (
    <div className="bg-[#fafafa] min-h-screen w-full">
      {/* Main Container */}
      <div className="content-stretch flex flex-col items-center pb-[48px] px-4 sm:px-6 md:px-8 lg:px-[32px] w-full">
        <div className="content-stretch flex flex-col gap-[32px] items-start max-w-[1220px] w-full">
          ...
          <div className="content-stretch flex flex-col gap-[14px] items-start pt-6 md:pt-[32px] w-full">
            ...
            <div className="content-stretch flex items-start w-full overflow-x-auto">
              ...
              >
                <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] text-[#737373] text-[14px] hover:text-[#171717]">
                  Companies
                </p>
              </button>
            ...
            <div className="content-stretch flex flex-col sm:flex-row gap-4 sm:gap-0 items-start sm:items-center justify-between w-full">
              <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] text-[#171717] text-[24px] md:text-[30px]">
                <p className="leading-[28px] md:leading-[32px]">{vehicleData.regNumber}</p>
              </div>
              <div className="content-stretch flex gap-[14px] items-center shrink-0">
                <button 
                  onClick={() => navigate(`/companies/${providerId}/vehicles/${vehicleId}/edit`)}
                  className="bg-[#05376d] flex gap-[6px] items-center justify-center pl-[14px] pr-[16px] py-[8px] rounded-[8px] shadow-[0px_0.5px_2px_0px_rgba(0,0,0,0.05)] shrink-0 hover:bg-[#04305c] transition-colors"
                >
          ...
          <div className="bg-white w-full rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] overflow-hidden">
            <div className="content-stretch flex flex-col lg:flex-row gap-[22px] items-start p-4 md:p-[24px] w-full">
              {/* Left Column */}
              ...
              <div className="flex-1 flex flex-col gap-[12px] items-start w-full">
                <div className="flex flex-col items-start w-full">
                  ...
                  <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#171717] text-[14px]">
                    {vehicleData.technicalPassportNumber}
                  </p>
                </div>
                <div className="flex flex-col items-start w-full">
                  <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] text-[#171717] text-[14px]">
