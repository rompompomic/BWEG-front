...
p2f0f9600: "M36.2191 9.27148H29.7905V11.4801H36.2191V9.27148Z",
...
p336da280: "M26.133 4.51965L24.3185 7.73327L20.1873 15.0404L19.5146 16.2339H21.9999L28.6179 4.51965H26.133Z",
p35a3b400: "M38.9971 4.51965H29.7905V6.72824H38.9971V4.51965Z",
...
p6fcc8c0: "M38.9971 14.0237H29.7905V16.2338H38.9971V14.0237Z",
...
function Frame3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[51px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 51.0056 20">
        <g id="Frame 35">
          <path d={svgPaths.p35a3b400} fill="var(--fill-0, #05376D)" id="Vector" />
          <path d={svgPaths.p6fcc8c0} fill="var(--fill-0, #05376D)" id="Vector_2" />
          <path d={svgPaths.p2f0f9600} fill="var(--fill-0, #05376D)" id="Vector_3" />
          <path d={svgPaths.p1e8a1400} fill="var(--fill-0, #05376D)" id="Vector_4" />
          <path d={svgPaths.p1f8fe800} fill="var(--fill-0, #05376D)" id="Vector_5" />
          <path d={svgPaths.p336da280} fill="var(--fill-0, #05376D)" id="Vector_6" />
          <path d={svgPaths.p24991000} fill="var(--fill-0, #05376D)" id="Vector_7" />
        </g>
      </svg>
    </div>
  );
...
function SidebarList() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Planner</p>
    </div>
  );
}

function SidebarList1() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Orders</p>
    </div>
  );
}

function SidebarList2() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Invoices</p>
    </div>
  );
}

function SidebarList3() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <div aria-hidden="true" className="absolute border-[#c2c2c2] border-b-2 border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Clients</p>
    </div>
  );
}

function SidebarList4() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Providers</p>
    </div>
  );
}

function SidebarList5() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Companies</p>
    </div>
  );
}

function SidebarList6() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Services</p>
    </div>
  );
}

function SidebarList7() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Promo</p>
    </div>
  );
}

function SidebarList8() {
  return (
    <div className="content-stretch flex gap-[12px] h-full items-center justify-center px-[10px] py-[8px] relative shrink-0" data-name="Sidebar list">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#404040] text-[14px]">Employers</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="bg-white content-stretch flex gap-[12px] h-full items-start px-[14px] relative shrink-0 w-[985px]" data-name="Container">
      <SidebarList />
      <SidebarList1 />
      <SidebarList2 />
      <SidebarList3 />
...
function FieldSearch() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[222px]" data-name="field-search">
      <Input />
    </div>
  );
}
...
function Profile() {
  return (
    <div className="bg-[#171717] overflow-clip relative rounded-[100px] shrink-0 size-[36px]" data-name="Profile">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] left-1/2 not-italic text-[16px] text-center text-white top-1/2 whitespace-nowrap">
        <p className="leading-[28px]">DU</p>
      </div>
    </div>
  );
}
...
function BarBweg() {
  return (
    <div className="bg-white content-stretch flex h-[68px] items-center justify-between pl-[24px] pr-[32px] relative shrink-0 w-[1440px]" data-name="bar_BWEG">
...
function Tab1() {
  return (
    <div className="bg-[#fafafa] content-stretch flex gap-[10px] h-[36px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#d97706] text-[14px]">All</p>
    </div>
  );
}
...
function Tab2() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[36px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#737373] text-[14px]">Personal</p>
    </div>
  );
}
...
function Tab3() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[36px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#737373] text-[14px]">Legal</p>
    </div>
  );
}
...
function Tab4() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[36px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#737373] text-[14px]">Governmental</p>
    </div>
  );
}
...
function HeadingPageTabs() {
  return (
    <div className="absolute bg-[#fafafa] content-stretch flex flex-col items-center left-0 top-[24px] w-[1220px]" data-name="Heading_page / Tabs">
      <Tab />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#171717] text-[30px] whitespace-nowrap">
        <p className="leading-[32px]">Clients</p>
      </div>
      <Button />
    </div>
  );
...
function Fields5() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[137px]" data-name="fields">
      <Input7 />
    </div>
  );
}
...
function Input8() {
  return (
    <div className="bg-white h-[38px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[7px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Lats order</p>
          <Calendar />
        </div>
      </div>
    </div>
...
function Input9() {
  return (
    <div className="bg-white h-[38px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[7px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Last invoice</p>
          <Calendar1 />
        </div>
      </div>
    </div>
...
function Container5() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Container">
      <SwitchOff />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">Unpaid invoices</p>
    </div>
  );
}
...
function HeroiconsOutlineUserCircle() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
          <path d={svgPaths.p45fa600} id="Vector" stroke="var(--stroke-0, #05376D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Cell10() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      <div aria-hidden="true" className="absolute border-[#e5e5e5] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center pb-px px-[16px] relative size-full">
...
function HeroiconsOutlineBuildingOffice() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/building-office">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/building-office">
          <path d={svgPaths.p32f0f880} id="Vector" stroke="var(--stroke-0, #05376D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center pb-px px-[16px] relative size-full">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">SIA “Former”</p>
        </div>
      </div>
    </div>
  );
...
function HeroiconsOutlineFlag() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/flag">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/flag">
          <path d={svgPaths.p30009f80} id="Vector" stroke="var(--stroke-0, #05376D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[6px] items-center pb-px px-[16px] relative size-full">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Ministry</p>
        </div>
      </div>
    </div>
  );
...
function HeroiconsOutlineUserCircle1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
...
function HeroiconsOutlineUserCircle2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
...
function HeroiconsOutlineUserCircle3() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
...
function HeroiconsOutlineUserCircle4() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
...
function HeroiconsOutlineUserCircle5() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
...
function HeroiconsOutlineUserCircle6() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
...
function HeroiconsOutlineUserCircle7() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="heroicons-outline/user-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="heroicons-outline/user-circle">
...
function Col1() {
  return (
    <div className="relative shrink-0 w-[140px]" data-name="Col">
    ...
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">437857 - 84356</p>
        </div>
      </div>
    </div>
  );
...
function Cell21() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">40002202</p>
        </div>
      </div>
    </div>
  );
...
function Cell22() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">40002188</p>
        </div>
      </div>
    </div>
  );
...
function Cell30() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">B2C</p>
        </div>
      </div>
    </div>
  );
...
function Cell31() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">B2B</p>
        </div>
      </div>
    </div>
  );
...
function Cell32() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">{`GOV `}</p>
        </div>
      </div>
    </div>
  );
...
function InputTag() {
  return (
    <div className="bg-[#fffbeb] relative rounded-[6px] shrink-0" data-name="Input tag">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#c47e09] text-[14px] text-center">Prepayment</p>
      </div>
    </div>
  );
}
...
function InputTag1() {
  return (
    <div className="bg-[#fef2f2] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#fee2e2] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#dc2626] text-[14px] text-center">Blocked</p>
      </div>
    </div>
  );
}
...
function InputTag2() {
  return (
    <div className="bg-[#f2fdf5] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#d3f3df] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#16a34a] text-[14px] text-center">Active</p>
      </div>
    </div>
  );
}
...
function ExclamationTriangle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="exclamation-triangle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="exclamation-triangle">
          <path clipRule="evenodd" d={svgPaths.p17841600} fill="var(--fill-0, #A3A3A3)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function HeroiconsSolidLockClosed() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="heroicons-solid/lock-closed">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="heroicons-solid/lock-closed">
          <path clipRule="evenodd" d={svgPaths.p2ea5fa80} fill="var(--fill-0, #A3A3A3)" fillRule="evenodd" id="Union" />
        </g>
      </svg>
    </div>
  );
...
function CheckBadge() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="check-badge">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="check-badge">
          <path clipRule="evenodd" d={svgPaths.p1817e800} fill="var(--fill-0, #A3A3A3)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function InputTag10() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">Standart</p>
      </div>
    </div>
  );
}
...
function InputTag11() {
  return (
    <div className="bg-[#fafafa] relative rounded-[6px] shrink-0" data-name="Input tag">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center px-[6px] py-[2px] relative">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#525252] text-[14px] text-center">Contract</p>
      </div>
    </div>
  );
}
...
function Cell80() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">-</p>
        </div>
      </div>
    </div>
  );
...
function Cell81() {
  return (
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Cell">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-px px-[16px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">2 (1000 €)</p>
        </div>
      </div>
    </div>
  );
...
export default function Clients() {
  return (
    <div className="bg-[#fafafa] content-stretch flex flex-col items-start overflow-clip relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] size-full" data-name="Clients">
      <BarBweg />
      <Body />
    </div>
  );
