...
import imgCard from "figma:asset/f2b4fd0148f6eecc53e5ba9a84c8b88aedb5e596.png";
...
function Card1() {
  return (
    <div className="h-[348px] relative shrink-0 w-full" data-name="Card">
...
function List() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="List">
      <Label />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px] w-full whitespace-pre-wrap">Carnikava</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[22px] items-start relative w-full">
        <Frame />
        <Frame2 />
        <Frame1 />
        <List3 />
...
function Card() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[22px] items-start overflow-clip p-[24px] relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] shrink-0 w-[1220px]" data-name="Card">
      <Card1 />
      <Frame3 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#171717] text-[24px] whitespace-nowrap">
        <p className="leading-[28px]">Category prices</p>
      </div>
      <Button3 />
    </div>
  );
...
function Frame16() {
  return (
    <div className="bg-[#fafafa] relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_0px_#ececee] shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[14px] items-start justify-center p-[24px] relative w-full">
