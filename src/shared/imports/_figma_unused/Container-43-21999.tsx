    ...
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 overflow-clip size-[12px] top-1/2" data-name="WhatsApp">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Group">
          ...
          <path clipRule="evenodd" d={svgPaths.peb08d00} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function Telegram() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-0.75px)] size-[12px] top-1/2" data-name="Telegram">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Telegram">
          <path clipRule="evenodd" d={svgPaths.p1f07d480} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Tab6() {
  return (
    <div className="bg-[#fafafa] content-stretch flex gap-[10px] h-[36px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#d97706] text-[14px]">Working Hours</p>
    </div>
  );
}
...
function Tab9() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[36px] items-center justify-center px-[12px] relative rounded-[8px] shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#737373] text-[14px]">Inventory categories</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#171717] text-[24px] whitespace-nowrap">
        <p className="leading-[28px]">Working Hours</p>
      </div>
      <Frame11 />
    </div>
  );
...
function FieldToggle() {
  return <div className="content-stretch flex flex-col gap-[8px] items-start justify-center shrink-0" data-name="field-toggle" />;
}
...
function Detail() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center leading-[20px] not-italic relative shrink-0 text-[#171717] text-[20px] w-full" data-name="Detail">
      <p className="relative shrink-0">08:00</p>
      <p className="relative shrink-0">-</p>
      <p className="relative shrink-0">20:00</p>
    </div>
  );
}
...
function Label9() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#737373] text-[14px] whitespace-pre-wrap">33 hours before days offers are closed</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] not-italic relative shrink-0 text-[#171717] text-[30px] tracking-[-0.75px] w-full whitespace-pre-wrap">Monday</p>
        <Detail />
        <Label9 />
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee]" data-name="Status">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[24px] py-[22px] relative w-full">
          <Container6 />
        </div>
      </div>
    </div>
...
function Label10() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#737373] text-[14px] whitespace-pre-wrap">9 hours before days offers are closed</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] not-italic relative shrink-0 text-[#171717] text-[30px] tracking-[-0.75px] w-full whitespace-pre-wrap">Tuesday</p>
        <Detail1 />
        <Label10 />
      </div>
    </div>
...
function Container8() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] not-italic relative shrink-0 text-[#171717] text-[30px] tracking-[-0.75px] w-full whitespace-pre-wrap">Wednesday</p>
        <Detail2 />
        <Label11 />
      </div>
    </div>
...
function Detail3() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center leading-[20px] relative shrink-0 text-[#171717] text-[20px] w-full" data-name="Detail">
      <p className="relative shrink-0">08:00</p>
      <p className="relative shrink-0">-</p>
      <p className="relative shrink-0">20:00</p>
    </div>
...
function Container9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start not-italic relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[#171717] text-[30px] tracking-[-0.75px] w-full whitespace-pre-wrap">Thursday</p>
        <Detail3 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#737373] text-[14px] w-full whitespace-pre-wrap">9 hours before days offers are closed</p>
      </div>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start not-italic relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[#171717] text-[30px] tracking-[-0.75px] w-full whitespace-pre-wrap">Friday</p>
        <Detail4 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#737373] text-[14px] w-full whitespace-pre-wrap">9 hours before days offers are closed</p>
      </div>
    </div>
...
function Detail5() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center leading-[20px] relative shrink-0 text-[#171717] text-[20px] w-full" data-name="Detail">
      <p className="relative shrink-0">08:00</p>
      <p className="relative shrink-0">-</p>
      <p className="relative shrink-0">19:00</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start not-italic relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[#171717] text-[30px] tracking-[-0.75px] w-full whitespace-pre-wrap">Saturday</p>
        <Detail5 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#737373] text-[14px] w-full whitespace-pre-wrap">9 hours before days offers are closed</p>
      </div>
    </div>
...
function TableCard1() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-start justify-center min-w-[272px] overflow-clip px-[24px] py-[22px] relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] shrink-0 w-[1220px]" data-name="Table card">
      <Body1 />
    </div>
  );
}
...
function Container14() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Container">
      <SwitchOn />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px]">On</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[20px] items-center px-[24px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] min-h-px min-w-px not-italic relative text-[#171717] text-[18px] whitespace-pre-wrap">Special prices</p>
          <FieldToggle1 />
        </div>
      </div>
    </div>
...
function Label12() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#171717] text-[14px]">Price period name</p>
    </div>
  );
}
...
function XMark() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="x-mark">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="x-mark">
          <path d={svgPaths.p23a8e180} fill="var(--fill-0, #737373)" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="bg-white h-[38px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[7px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px not-italic overflow-hidden relative text-[#171717] text-[14px] text-ellipsis whitespace-nowrap">Price period</p>
          <XMark />
          <ChevronDown />
        </div>
      </div>
...
function Row() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Row">
...
function ChevronUp() {
  return (
    <div className="relative size-[24px]" data-name="chevron-up">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="chevron-up">
          <path clipRule="evenodd" d={svgPaths.pce5c80} fill="var(--fill-0, #A3A3A3)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-between relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#171717] text-[18px]">Container service</p>
...
function Label14() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] whitespace-pre-wrap">Base price</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="bg-white relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_0px_#ececee] shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center p-[8px] relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px] w-full whitespace-pre-wrap">100 €</p>
        </div>
      </div>
    </div>
  );
...
function Label15() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] whitespace-pre-wrap">Fix delivery price in cents</p>
    </div>
  );
}
...
function Label16() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] whitespace-pre-wrap">Price per km</p>
    </div>
  );
}
...
function Label17() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] whitespace-pre-wrap">Minimal order price</p>
    </div>
  );
}
...
function Label18() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[24px] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] whitespace-pre-wrap">Price coefficient</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="bg-white relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_0px_#ececee] shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center p-[8px] relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px] w-full whitespace-pre-wrap">1</p>
        </div>
      </div>
    </div>
  );
...
function Frame27() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Fix delivery price</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#171717] text-[14px]">Free of charge</p>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-start justify-end relative w-full">
        <Frame39 />
        <Frame29 />
      </div>
    </div>
...
function Frame25() {
  return (
    <div className="bg-white relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_0px_#ececee] shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[14px] items-start justify-center p-[24px] relative w-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#171717] text-[18px] w-full whitespace-pre-wrap">6 m³</p>
          <Frame24 />
        </div>
      </div>
    </div>
...
function Frame40() {
  return (
    <div className="bg-white relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_0px_#ececee] shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[14px] items-start justify-center p-[24px] relative w-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#171717] text-[18px] w-full whitespace-pre-wrap">9 m³</p>
          <Frame26 />
        </div>
      </div>
    </div>
...
function TableCard2() {
  return (
    <div className="bg-[#fafafa] content-stretch flex flex-col gap-[14px] items-start justify-center min-w-[272px] overflow-clip relative rounded-[12px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#ececee] shrink-0 w-full" data-name="Table card">
      <Body3 />
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-between relative w-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#171717] text-[18px]">Additional service</p>
        <div className="flex items-center justify-center relative shrink-0">
          <div className="-scale-y-100 flex-none">
            <ChevronUp1 />
          </div>
...
function Container12() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start max-w-[1220px] relative shrink-0 w-[1220px]" data-name="Container">
      <Card2 />
    </div>
  );
}
