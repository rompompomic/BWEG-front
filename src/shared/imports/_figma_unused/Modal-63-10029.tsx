    ...
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pb-[8px] pl-[24px] pr-[16px] pt-[24px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] min-h-px min-w-px not-italic relative text-[#171717] text-[18px] whitespace-pre-wrap">Choose date new prices come into force</p>
        </div>
      </div>
    </div>
  );
...
function SectionModalHeadA() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Section modal / Head A">
      <Container />
      <div className="-translate-y-1/2 absolute overflow-clip right-[876px] size-[24px] top-[calc(50%+40px)]" data-name="x-mark">
...
function Label() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0 w-full" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#171717] text-[14px]">Date new prices come into force</p>
    </div>
  );
}
    ...
    <div className="bg-white h-[38px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.06),0px_0px_0px_1px_#e5e5e5] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[14px] py-[7px] relative size-full">
          ...
          <div className="overflow-clip relative shrink-0 size-[18px]" data-name="calendar">
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[12px] shadow-[0px_3px_8px_0px_rgba(0,0,0,0.14)] shrink-0 w-[900px]">
      <SectionModalHeadA />
      <Body />
      <SectionModalActionA />
    </div>
...
export default function Modal() {
  return (
    <div className="bg-[rgba(0,0,0,0.5)] content-stretch flex flex-col items-center justify-center p-[80px] relative size-full" data-name="Modal">
      <Frame />
    </div>
  );
}